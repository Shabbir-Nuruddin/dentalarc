...
import { Star, ArrowUpRight, Phone, Clock, ShieldCheck, Sparkles, MapPin, Heart } from "lucide-react";
...
export default function Hero() {
  ...
  const smoothY = useSpring(useTransform(scrollYProgress, [0, 1], [0, 60]), {
    stiffness: 100,
    damping: 25,
  });
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[92vh] pt-32 sm:pt-36 pb-20 flex items-center bg-[#FAF9F6] text-slate-900 overflow-hidden border-b-2 border-slate-900"
    >
      {/* Subtle Salt Crystal Grid Texture */}
      ...
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-700 via-teal-500 to-amber-500 origin-left z-50 pointer-events-none"
      ...
      <div className="layout-container relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          >
            ...
            {/* Google & Practo Rating Micro-Pill */}
            <div className="inline-flex items-center gap-2">
              ...
              >
                ...
                <span className="text-xs font-bold text-teal-800 flex items-center gap-1 group-hover:underline">
                  250+ Verified Reviews <ArrowUpRight className="w-3 h-3" />
                </span>
              </a>
            ...
            <div className="space-y-3">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 leading-[1.08]">
                Personalized, Painless &<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-800 via-teal-600 to-slate-900">
                  Evidence-Based Dentistry
                </span>
              </h1>
              <p className="text-base sm:text-lg text-slate-700 max-w-xl font-normal leading-relaxed">
                Led by <strong>Dr. Madhushree Agarwal</strong> (15+ Years Clinical Excellence • Dr. R. Ahmed Dental College Alumna • Ex-Clove Clinic Head). Conservative tooth preservation, painless rotary root canals, and family dentistry in Gurugram.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-4">
              ...
              <a
                href="https://wa.me/919999385782?text=Hi%20Dr.%20Madhushree%2C%20I%20would%20like%20to%20book%20a%20dental%20consultation%20at%20The%20Dental%20Salt."
                target="_blank"
              ...
              >
                ...
                <span>WhatsApp Dr. Madhushree</span>
              </a>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-slate-800 hover:text-teal-800 text-sm font-bold px-5 py-3.5 rounded-full border-2 border-slate-900 bg-white shadow-offset-sm hover:translate-x-0.5 hover:-translate-y-0.5 transition-all"
              >
            ...
            <div className="pt-2 flex items-center gap-6 text-xs text-slate-500 font-mono">
              <span className="flex items-center gap-1.5">
                ...
                <span>Tapasya Grand Walk, Sec 70 & Golf Course Ext.</span>
              </span>
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-slate-200 bg-slate-100">
                <motion.div style={{ scale: photoScale }} className="w-full h-full">
                  <ClinicImage
                    ...
                    alt="The Dental Salt sterile operatory suite in Sector 70 Gurugram"
                ...
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur-md px-3 py-1 rounded-md text-[10px] font-mono font-bold uppercase tracking-wider text-slate-900 border border-slate-900 shadow-sm flex items-center gap-1.5">
                  ...
                  <span>The Dental Salt • Active Operatory</span>
                </div>
              </div>

              {/* Architectural Caption Strip */}
              <div className="p-3.5 bg-[#FAF9F6] rounded-xl border border-slate-200 mt-2.5 flex items-center justify-between text-xs">
                <div>
                  <p className="font-bold text-slate-900">The Dental Salt Operatory Suite</p>
                  <p className="text-slate-500 text-[11px] font-mono">Tapasya Grand Walk C-112A, Sector 70 Gurugram</p>
                </div>
